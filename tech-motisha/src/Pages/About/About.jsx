...
import dataScience from '../About/assets/data_science.png'
import devops2 from '../About/assets/devops_new.png'
import cybersec from '../About/assets/cybersec.png'
    ...
    <div className='about_container'>
      <div>
        <div className='heading'>
          ...
          <h1 className='what align-text-middle'>WHAT</h1>
        </div>
   
        <p className='about_description'>Welcome to our community-driven learning platform for students interested in the tech industry! Our mission is to provide you with authentic insights and inspiration from industry experts, Moringa alumni, and staff, empowering you to unlock your potential in the tech space.
        <br />
      ...
      <div className='courses_grid'>
        ...
        <img className='category_logo' src={devops2} alt="html_icon" />
          DEVOPS
          </span>
        <span  style={{backgroundColor: 'rgba(23,43,90,1)'}}  className='plot montserrat-black-white-20px'>
        <img className='category_logo' src={cybersec} alt="html_icon" />
          CYBER SECURITY
          </span>
        <span style={{backgroundColor: 'rgba(14,33,69,1)'}} className='plot montserrat-black-white-20px'>
        <img className='category_logo' src={dataScience} alt="html_icon" />
          DATA SCIENCE
          </span>
        <span style={{backgroundColor: 'rgba(14,33,69,1)'}} className='plot montserrat-black-white-20px'>
        <img className='category_logo' src={software} alt="html_icon" />
