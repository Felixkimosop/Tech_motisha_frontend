    ...
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            !toggle ? "flex" : "hidden"
          } p-6 bg-black-gradient absolute top-20 right-0 mx-6 my-2 min-w-[240px] rounded-xl sidebar`}
        >
          <ul className="list-none flex justify-end p-6 px-20 items-start flex-1 flex-col">
            {links.map((nav, index) => (
              <li
                key={nav.name}
